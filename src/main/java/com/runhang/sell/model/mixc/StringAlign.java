 ...
 * @ClassName
 * @Author fangyueben
 * @Date 2019/4/13 13:27
 * @Version 1.0
 * @Description 字符串对齐器。可以指定对齐格式和一行的最大字符数 对齐格式有左对齐、居中、右对齐
 **/
public class StringAlign {
    ...
    public static void main(String[] args) {
        // 一行最多70个字符，居中显示。
        StringAlign formatter = new StringAlign(80, StringAlign.JUST_CENTER);
        // 比如显示页码
//        System.out.println(formatter.format("- i -"));
//        System.out.println(formatter.format("抱歉,该机器商品库存不足,请移步其他机器取货\n客服电话：0633-3625 007"));
//        // 左对齐
//        System.out.println();
//        formatter = new StringAlign(80, StringAlign.JUST_LEFT);
//        System.out.println(formatter.format("- i -"));
//        System.out.println(formatter.format("抱歉,该机器商品库存不足,请移步其他机器取货\n客服电话：0633-3625 007"));
//        // 右对齐
//        System.out.println();
//        formatter = new StringAlign(80, StringAlign.JUST_RIGHT);
//        System.out.println(formatter.format("- i -"));
//        System.out.println(formatter.format("抱歉,该机器商品库存不足,请移步其他机器取货\n客服电话：0633-3625 007"));

        String a = "抱歉,该机器商品库存不足,请移步其他机器取货";
        String b = "客服电话：0633-3625 007";

        formatter = new StringAlign(a.length()+10, StringAlign.JUST_CENTER);
        // 比如显示页码
        System.out.println(formatter.format("- i -"));
        System.out.println("1");
        System.out.println(a.length());
        System.out.println(b.length());
        String c = formatter.format(b);
    ...
    public static String disposePhone(String a,String b){
        StringAlign formatter = new StringAlign(a.length()*2, StringAlign.JUST_CENTER);
        String c = formatter.format(b);
       return "\n"+c;
    }
}
