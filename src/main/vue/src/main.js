...
//	this.$router.replace('/noWechat')
  ...
  if (wxUserInfoState == false) {
    ...
    // let redirectUrl = encodeURIComponent('http://rhtech.runhangtech.com/runhang/wxAuth?dataTime='+new Date().getTime())
    let redirectUrl = encodeURIComponent('http://rhtech.runhangtech.com/wxAuth')
    //判断是否为正式环境
