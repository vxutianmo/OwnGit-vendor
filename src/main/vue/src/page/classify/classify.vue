...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapMutations([
        'RECORD_ADDRESS','ADD_CART','REDUCE_CART','INIT_BUYCART','CLEAR_CART','RECORD_SHOPDETAIL', 'SAVE_GEOHASH','RECORD_CART','RECORD_VENDINGPOSITION'
        // ,'RECORD_MENU'
      ]),
      addOneButton(foods){
      ...
      async initData(){
        ...
        // getVendorGoods(this.vending['vdCode'],localStorage.getItem('openId')).then((res)=>{
