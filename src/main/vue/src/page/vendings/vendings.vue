...
<script>
  import { getVendorInfo,getVendorGoods } from 'src/service/getData'
  ...
  import {mapState, mapMutations} from 'vuex'
	...
	export default {
	    ...
	    computed:{
	      ...mapState([
	        'vendingMessage','openId'
	      ]),
	    },
		methods: {
	      ...mapMutations([
	        'VENDING_MESSAGE','RECORD_MENU'
	      ]),
...
//				});
        ...
        getVendorGoods(this.vendingMessage.vdCode,this.openId).then((res)=>{
